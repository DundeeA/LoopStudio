      ...
      <div className="w-[20rem] lg:w-[70rem] md:w-[50rem] relative">
        ...
        <div
         ...
         md:left-[18rem] md:bottom-[11rem]   md:block  flex flex-col items-center">
          <h1
            className=" text-black w-[20rem] mt-10  tracking-[.2rem] leading-[2.4rem]  text-[1.8rem]   md:tracking-[.11rem] md:leading-[3.3rem] 
                              lg:text-black 
                              
                              md:text-[2.8rem] md:w-[22rem]">
            THE LEADER IN INTERACTIVE VR
          </h1>

          <p className="text-[.9rem]  leading-6 mt-5 font-Alata text-gray-600 lg:mt-8 w-[17rem] lg:w-[27rem] md:w-[25rem]">
