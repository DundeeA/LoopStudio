...
function Creations() {
  return (
    <div className="mt-20 md:mt-0 pt-1 flex flex-col items-center w-full">
      <div className="w-full md:flex md:justify-between md:items-center md:w-[77%]">
        ...
        <button className="border tracking-widest font-semibold border-black w-40 h-10 hidden md:inline">SEE ALL</button>
      </div>

      <div className=" grid grid-cols-1  md:grid-cols-4  ]  md:mt-[4.4rem]  w-[89vw] md:w-[80%] pl-6 justify-center">
      ...
      <button className="border tracking-widest font-semibold border-black w-40 h-10 mt-2 md:hidden">SEE ALL</button>
    </div>
  )
}
